...
const StatsChamps = (props) => {
  ...
  return (
    <>
      <div className="mb-3">
      <Alert variant="danger">La saisie des notes de champs disciplinaires n'est plus nécessaire pour cette année. Merci infiniment pour vos contributions, les statistiques sont maintenant complètes et permettent de calculer votre score de cette année.</Alert>
      ...
      { <Alert variant="danger">Il n'est plus nécessaire de saisir d'autres données ici. Merci infiniment pour vos contributions, les statistiques sont maintenant connues et permettent de calculer votre score de cette année.</Alert> }
