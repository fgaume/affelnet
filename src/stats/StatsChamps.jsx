  ...
  return (
    <>
      <div className="mb-3">
        ...
        suffisent (plus ils sont éloignés, mieux c'est, donc n'hésitez pas à un
        ajouter un 3e !). Ces couples (note brute, note harmonisée) sont
        indiqués sur ce tableau de votre fiche barème :
      </div>
