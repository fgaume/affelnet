...
const StatsChamps = (props) => {
  ...
  return (
    <>
      <div className="mb-3">
        <ArrowReturnRight /> L'interface ci-dessous vous permet de saisir les données
        nécessaires au calcul de la moyenne et écarts-types des champs
        ...
        suffisent (plus ils sont éloignés, mieux c'est, donc n'hésitez pas !).
        Ces couples (note brute, note harmonisée) sont indiqués sur ce
        tableau de votre fiche barème :
      </div>
      <div className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-8 col-xxl-8 mx-auto">
        <Figure>
          ...
          <Figure.Caption className="text-center">
            Fig. 2 : extrait d'une fiche barème listant les notes brutes et harmonisées
        ...
        {champsDisciplinaires.map((champ, idx) => {
          return (
            <Col key={idx} className="mt-2">
              <ListeStatsChamp key={champ} champ={champ} />
            </Col>
          );
        })}
      </Row>
