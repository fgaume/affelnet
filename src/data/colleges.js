/*
  listeColleges est la liste de tous les collèges, utilisées par le module de recherche de collège
  collegesMap est une map permettant de retrouver un objet Collège à partir d'un code, utilisé
  lors de l'appel d'API Secteur Rectorat
  Le bonus IPS vient de la circulaire, le dnb_admis (2022) vient de l'opendata
*/
const listeColleges = [
  {
    "code": "0755433Y",
